...
ZKPassport SDK is available as a package on npm and accessible publicly on GitHub. It is meant to work both in the browser and in Node.js.
...
To see how to use the SDK to request information from users, check out the Basic Usage guide.

tip
Looking for a quick start? You can check out our Next.js boilerplate here.