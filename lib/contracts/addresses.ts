...
export interface ChainContracts {
  ...
  MANUAL_PRICE_AGGREGATOR: `0x${string}`;
  // Tokens
  USDC: `0x${string}`;
  EURC: `0x${string}`;
  ECOP: `0x${string}`;
...
const DETERMINISTIC = {
  ...
  MANUAL_PRICE_AGGREGATOR:  '0x0000000000000000000000000000000000000000' as `0x${string}`,
...
export const CONTRACTS: Record<ChainId, ChainContracts> = {
  ...
  11155111: {
    ...
    PASSPORT_GATED_HOOK:     '0xd3f980f48638783a8324ff99301028f08bda8a80',
    MANUAL_PRICE_AGGREGATOR: '0xBebDf2e6AdF4ca1e26531A778cdf669Da989EB79',
