...
export const CONTRACTS: Record<ChainId, ChainContracts> = {
  ...
  84532: {
    ...
    ...DETERMINISTIC,
    PASSPORT_GATED_HOOK: '0x6aCd362aAe223f360C4c2e03cBD36190450b965E',
  ...
  11155111: {
    ...
    ...DETERMINISTIC,
    PASSPORT_GATED_HOOK: '0x6B56590865Eecf2a0Ee5988ABecB924a33749D46',
...
export const PRIMARY_TESTNET_CHAIN_ID: ChainId = 84532;
